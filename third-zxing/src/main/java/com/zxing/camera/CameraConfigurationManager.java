...
/**
 * Description: This class is mainly responsible for setting camera parameters and obtaining the best preview interface
 *
...
public final class CameraConfigurationManager {
    ...
    /**
     * Calculate the most suitable preview interface size from the resolution supported by the camera
     * @param parameters
