 ...
 *
 * GridView，它以节的形式显示项目，标题粘贴在视图的顶部。
 */
public class StickyGridHeadersGridView extends GridView implements OnScrollListener, OnItemClickListener,
     ...
     *
     * 获取位于项位置的标头。但是，该位置必须是HeaderFiller的位置。
     * @param position HeaderFiller的位置。
     * @return 头部视图包装在HeaderFiller中，如果没有找到头部，则为空。
     */
     ...
     *
     * 如果设置为true，则headers将忽略水平填充。
     * @param b 如果为true，则水平填充将被头文件忽略
     */
     ...
     *
     * Runnables的基类，它将检查它们的视图是否与创建Runnable时一样仍然附加到原始窗口。
     */
