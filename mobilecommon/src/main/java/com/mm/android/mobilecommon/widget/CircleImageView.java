...
public class CircleImageView extends AppCompatImageView {
     ...
     *
     * 返回圆形可绘制对象后面绘制的颜色。
     * @return 在可绘制对象后面绘制的颜色
     * @deprecated 使用{@link #getCircleBackgroundColor()}代替。
     */
    @Deprecated
     ...
     *
     * 设置要在圆形可绘制对象后面绘制的颜色。注意，如果可绘制对象是不透明的或未设置可绘制对象，则此设置无效。
     * @param fillColor 在可绘制对象后面绘制的颜色
     * @deprecated 使用{@link #setCircleBackgroundColor(int)}代替。
     */
    @Deprecated
     ...
     * @deprecated 使用{@link #setCircleBackgroundColorResource(int)}代替。
     */
    @Deprecated
